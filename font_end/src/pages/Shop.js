...
const { data: products, isLoading: queryLoading, isPreviousData } = useQuery( ["products" ,limit,searchProduct],
  fetchProductAll,
  {
    retry: 3,
    retryDelay: 1000,
              ...
              <div className="col-lg-9 col-12 col-custom widget-mt">
                <Loading isLoading={queryLoading}>
                  ...
                  <Flex justify="center" align="center">
                    <Button disabled={products?.totalProduct === products?.data?.length} className="ant-btn-primary" style={{marginBottom:"50px",padding:"20px 40px", fontWeight:"500"}} onClick={()=>setLimit((prev) => prev + 6)}>
                      Xem thêm
                    </Button>
                  </Flex>
